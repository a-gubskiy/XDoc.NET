...
public class SimpleDocumentationReference : DocumentationReference
{
    ...
    /// </summary>
    public bool IsInherit { get; init; }
    ...
    /// <param name="isInherit">A value indicating whether this documentation inherits from another element.</param>
    public SimpleDocumentationReference(XmlNode requirementNode, string cref, bool isInherit)
