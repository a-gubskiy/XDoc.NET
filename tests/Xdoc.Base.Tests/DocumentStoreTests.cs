...
public class DocumentStoreTests
{
    ...
    public async Task Test1()
    {
        ...
        Assert.Null(dogsFriend);
        

        Assert.NotNull(catClassInfo);
        Assert.NotNull(dogClassInfo);
        Assert.NotNull(catNamePropertyInfo);
        Assert.NotNull(blackCatNamePropertyInfo);
        Assert.NotNull(orangeCatNamePropertyInfo);
        Assert.NotNull(dogNamePropertyInfo);
        Assert.NotNull(animalFriend);
    }
}